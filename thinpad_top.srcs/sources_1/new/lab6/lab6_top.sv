...
module lab6_top (
    ...
    always_comb begin
        ...
        if (~rst & ~_if_pc_misaligned & ~core_tlb_clear & ~id_is_branch
            ...
            & ~mem_prev_exception & ~wb_prev_exception & ~(_if_control_flow_change &(_if_inst_addr == _if_inst_pc))) begin // TODO: _if_control_flow_change
    ...
    always_comb begin
        if ((exe_is_branch & exe_branch_take) | wb_prev_exception | (_if_inst_addr == _if_inst_pc)) begin
    ...
    // assign core_tlb_clear = (wb_prev_mcause == `EXP_SFENCE_VMA) | wb_pre; // TODO: move to other place
    // assign core_tlb_clear = (wb_prev_mcause == `EXP_SFENCE_VMA) | (wb_prev_mcause == `EXP_SRET); // TODO: test with only U-mode cache
