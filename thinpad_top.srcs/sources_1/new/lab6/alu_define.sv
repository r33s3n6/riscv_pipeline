...
//`define CSR_ID_CYCLE    5'd0 // (shadow of mcycle)      // read only
`define CSR_ID_TIME     5'd1 // (shadow of mmio-mtime)  // read only
//`define CSR_ID_CYCLEH   5'd2 // (shadow of mcycleh)     // read only
`define CSR_ID_TIMEH    5'd3 // (shadow of mmio-mtimeH) // read only

// `define CSR_ID_SSTATUS  5'd4 // (shadow of mstatus)
// `define CSR_ID_SIE      5'd5 // (shadow of mie)
...
// `define CSR_ID_SIP      5'd11 // (shadow of mip)
...
`define EXP_MRET        32'd25
`define EXP_SRET        32'd26
`define EXP_SFENCE_VMA  32'd27
